...
class ModelConfig():
    ...
    """
    The attention mode for the decoding block. 
    Options: 'baseline', 'local_window', 'swin_window'.
    """

    local_window_size: int = 8
    """
    Window size for local and swin window attention.
    """

    shift_size: int = 4
    """
    Shift size for swin window attention on odd layers.
    """

    block_length: int = 32
    """
    The current decoding block length / window context boundary.
    """

    steps: int = 128
    """
    Number of sampling steps used during discrete diffusion decoding.
    """

    temperature: float = 0.0
    """
    Categorical distribution sampling temperature.
    """

    remasking: str = "low_confidence"
    """
    Remasking strategy employed during generation (e.g. low_confidence).
    """
