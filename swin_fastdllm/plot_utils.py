...
def plot_single_window_size(w, save_dir='results'):
    ...
    mem = [res_base['max_mem'], res_local['max_mem'], res_swin['max_mem']]
    ...
    bars = ax.bar(x, tps, width, color=['#d62728', '#1f77b4', '#ff7f0e'])
    ...
    # ==========================
    fig, ax = plt.subplots(figsize=(8, 6))
    bars = ax.bar(x, mem, width, color=['#d62728', '#1f77b4', '#ff7f0e'])
